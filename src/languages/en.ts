...
const translations = {
    common: {
        ...
        // @context Provides an example format for a website URL. The abbreviation “e.g.” should be localized according to the target language.
        websiteExample: 'e.g. https://www.expensify.com',
        // @context Provides an example format for a ZIP/postal code. Preserve placeholders such as ${zipSampleFormat}. Localize “e.g.” as appropriate.
        ...
        emptyLHN: {
            ...
            // @context Instructional text directing the user to find a chat. Should be translated using an imperative verb form.
        ...
        dropTitle: 'Let it go',
        // @context Instruction for dropping one or more files into an upload area. Should support pluralization depending on allowed file count.
